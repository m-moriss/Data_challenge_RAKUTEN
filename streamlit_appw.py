...
import pandas as pd
from datasets import load_dataset, process_text, load_logisitc_regression_model,load_vgg16_cnn_model, get_image
...
""")
    ...
    #with Image.open('C:/Users/Morisseau1/AppData/Roaming/Python/Python310/site-packages/streamlit/streamlit/images/image_vgg16.png') as img:
